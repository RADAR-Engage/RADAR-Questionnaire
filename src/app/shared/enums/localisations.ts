export class LocKeys {
  ...
  static PROGRESS_REPORT_WAITING = new LocKeys('PROGRESS_REPORT_WAITING')
  static PROGRESS_REPORT_WAITING_TODAY = new LocKeys("PROGRESS_REPORT_WAITING_TODAY")
  static PROGRESS_REPORT_WAITING_TOMORROW = new LocKeys("PROGRESS_REPORT_WAITING_TOMORROW")
