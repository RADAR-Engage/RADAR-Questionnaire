          ...
          function h(a, c, d) {
            ...
            return (
              d.forEach(function (b) {
                b._tick(a, c),
                  b._inEffect
                    ? (g.push(b._effect), b._markTarget())
                    : (f.push(b._effect), b._unmarkTarget()),
                  b._needsTick && (m = !0)
            ...
            function j(j) {
              ...
              return (
                y > 1e-4
                  ...
                  : s[0][0] > s[1][1] && s[0][0] > s[2][2]
                  ? ((w = 2 * Math.sqrt(1 + s[0][0] - s[1][1] - s[2][2])),
                    (x = [
                      0.25 * w,
                      (s[0][1] + s[1][0]) / w,
                      (s[0][2] + s[2][0]) / w,
                  ...
                  : s[1][1] > s[2][2]
                  ? ((w = 2 * Math.sqrt(1 + s[1][1] - s[0][0] - s[2][2])),
                    (x = [
                      (s[0][1] + s[1][0]) / w,
                      0.25 * w,
                      (s[1][2] + s[2][1]) / w,
                  ...
                  : ((w = 2 * Math.sqrt(1 + s[2][2] - s[0][0] - s[1][1])),
                    (x = [
                      (s[0][2] + s[2][0]) / w,
                      (s[1][2] + s[2][1]) / w,
                      0.25 * w,
            ...
            if (/^[^(]*$|^calc/.test(b)) {
              ...
              if ('D' == e) {
                for (var h in c) {
                  var i = eval(
                    b
                      .replace(new RegExp('U' + h, 'g'), '')
                      .replace(new RegExp(d, 'g'), '*0')
                  )
